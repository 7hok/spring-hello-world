...
!0;a=new j(a,d);a.show();return a};var h={position:j.POSITION.TOP,fade_in_duration:j.SPEED.FAST,move_in_duration:100,move_in_from:10,full_visibility_duration:-2,fade_out_duration:j.SPEED.SLOW,move_out_duration:0,easing_in:"swing",easing_out:"linear",static_message:null,one_time_only:!1,insert_before:"body > *:first-child",calculated_time_offset:null,opacity:1,flash_on_text_change:!0};j.getDefaults=function(){return h};for(var t=/matooltip.css/i,r=0;r<document.styleSheets.length;++r){var s=void 0;
